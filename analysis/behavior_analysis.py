...
if __name__ == '__main__':
    ...
    context_session_table = '//sv-nas1.rcp.epfl.ch/Petersen-Lab/analysis/Pol_Bech/Pop_results/Context_behaviour/Context_behaviour_analysis_may2024/context_expert_sessions.xlsx'

    # Set the saving folder
    output_path = os.path.join('\\\\sv-nas1.rcp.epfl.ch', 'Petersen-Lab', 'analysis', experimenter, 'Pop_results',
                               'Context_behaviour', 'Context_behaviour_analysis_may2024')
    ...
    # RD_nwb_names = os.listdir(root_path.replace("Pol_Bech", "Robin_Dard"))
    # all_nwb_names += [file for file in RD_nwb_names if 'RD' in file]
    ...
    config_file = r"M:\analysis\Pol_Bech\Sessions_list\context_sessions.yaml"
