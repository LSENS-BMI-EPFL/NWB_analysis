...
if __name__ == '__main__':
    ...
    context_session_table = '//sv-nas1.rcp.epfl.ch/Petersen-Lab/analysis/Pol_Bech/Pop_results/Context_behaviour/context_expert_sessions.xlsx'

    # Set the saving folder
    output_path = os.path.join('\\\\sv-nas1.rcp.epfl.ch', 'Petersen-Lab', 'analysis', experimenter, 'Pop_results',
                               'Context_behaviour', 'Context_behaviour_analysis_20240502', 'expert')
    ...
    config_file = r"M:\analysis\Pol_Bech\Sessions_list\context_contrast_expert_sessions_path.yaml"
