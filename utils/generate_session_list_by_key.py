...
def filter_files_by_keyword(directory, mouse_id, keywords, expert_table):
    ...
    if keywords['expert'] is not None and expert_table:
...
if __name__ == "__main__":
    ...
    mouse_id = ["PB170", "PB171", "PB172", "PB173", "PB174", "PB175", "PB176", "PB177", "PB178", "PB179", "PB180", "PB181"]
    keywords = {'behaviour': ['whisker_context', 'context'],
                'imaging': 'wf', # wf or None
                'expert': True} # or True

    yaml_file = r"\\sv-nas1.rcp.epfl.ch\Petersen-Lab\analysis\Pol_Bech\Sessions_list\context_sessions_expert_wf.yaml"
